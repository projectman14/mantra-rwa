...
export default function ShineBorder({
  ...
  return (
    <div
      ...
      className={cn(
        "relative grid min-h-[2rem] w-fit min-w-[9rem] place-items-center rounded-2xl  bg-black p-3 text-white dark:bg-black dark:text-white",
        className,
      )}
    >
      <div
      ...
      ></div>
      <div className={"z-[1] h-full w-full rounded-2xl mb-2"}>
        {children}
      </div>
    </div>
  );
