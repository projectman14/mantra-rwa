...
export interface PaymasterfactoryInterface extends PaymasterfactoryReadOnlyInterface {
  contractAddress: string;
  sender: string;
  mintPaymasterAccount: (fee?: number | StdFee | "auto", memo?: string, _funds?: Coin[]) => Promise<ExecuteResult>;
}
export class PaymasterfactoryClient extends PaymasterfactoryQueryClient implements PaymasterfactoryInterface {
  ...
  mintPaymasterAccount = async (fee: number | StdFee | "auto" = "auto", memo?: string, _funds?: Coin[]): Promise<ExecuteResult> => {
