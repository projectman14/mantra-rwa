...
```sh
npm install TogetherFi
```
## Table of contents

- [TogetherFi](#TogetherFi)
  - [Install](#install)
...
Contract schemas live in `./contracts`. Look inside of `scripts/codegen.js` and configure the settings for bundling your SDK and contracts into `TogetherFi`:
